...
public class TicketService implements TicketDAO {
	...
	public List<Ticket> getAllByTS() {
		List<Ticket> lt = new ArrayList<>();
		ticketRepository.findAllByTS(4).forEach(lt::add);
		return lt;
	}
	
	public List<Ticket> getAllByTicketStatus1() {
		List<Ticket> lt = new ArrayList<>();
		ticketRepository.findAllByTicketStatus(1).forEach(lt::add);
		return lt;
	}
	
	public List<Ticket> getAllByTicketStatus2() {
		List<Ticket> lt = new ArrayList<>();
		ticketRepository.findAllByTicketStatus(2).forEach(lt::add);
		return lt;
	}

	public List<Ticket> getAllByTicketStatus3() {
		List<Ticket> lt = new ArrayList<>();
		ticketRepository.findAllByTicketStatus(3).forEach(lt::add);
		return lt;
	}

	public List<Ticket> getAllByTicketStatus4() {
		List<Ticket> lt = new ArrayList<>();
		ticketRepository.findAllByTicketStatus(4).forEach(lt::add);
		return lt;
	}
